  ...
  return (
    ...
    >
      <motion.a
        ...
        href="https://mail.google.com/mail/?view=cm&fs=1&to=aarushmishrashitalaprasad@gmail.com&su=Hello%20Aarush&body=I%20wanted%20to%20connect%20with%20you!"
        target="_blank"
        aria-label="email"
        onClick={() => {
          if (SoundActive) {
      ...
      <motion.a
        variants={childVariants}
        className={`${styles.links_link}`}
        href="https://www.linkedin.com/in/aarush-mishra-29a28927a/"
        target="_blank"
        aria-label="linkedin"
        onClick={() => {
          if (SoundActive) {
